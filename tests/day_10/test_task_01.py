...
# From apps
from day_10.task_01 import Task01
from tests.test_utils.get_input import get_input


class TestTask01(unittest.TestCase):
    def test_example_input_01(self):
        file_content = get_input("tests/day_10/input_example_01.txt")
    ...
    def test_example_input_02(self):
        file_content = get_input("tests/day_10/input_example_02.txt")
    ...
    def test_example_input_03(self):
        file_content = get_input("tests/day_10/input_example_03.txt")
    ...
    def test_example_input_04(self):
        file_content = get_input("tests/day_10/input_example_04.txt")
